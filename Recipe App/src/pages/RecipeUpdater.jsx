        ...
        <div className="bg-white rounded-xl shadow-sm  p-6">
          ...
          <form className="space-y-5" onSubmit={handleSubmit(SubmitHandler)}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              <button
                type="submit"
                className="sm:flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 shadow-sm"
              >
                Update Recipe
              </button>
              ...
              <button
                ...
                className="sm:px-6 bg-red-600 hover:bg-red-700 text-white font-medium py-3 rounded-lg transition-colors duration-200 shadow-sm"
              >
                Delete
              </button>
            </div>
